...
タップで開く解説に、英文全体と語句それぞれのカタカナ発音を表示します。
本文中には出しません(読む流れを保つため)。挿絵のキャプションにも付けています。

表記の方針:

- `/v/` は「ヴ」で書き、b と区別します(very → ヴェリー)
- `th` は無声をサ行、有声をザ行にします(think → シンク、this → ジス)
- `l` と `r` はどちらもラ行です(カタカナでは書き分けられません)
- 母音の前の the は「ジ」にします(the apple → ジ アプル)
